    ...
    return (
        <>
            <div className="h-screen flex items-center justify-center">
                ...
                {/* ══ PANEL IZQUIERDO ══ */}
                <div className="hidden md:flex w-2/5 bg-flota-surface h-full p-10 flex-col items-center justify-center gap-10 border-r border-flota-textPrimary text-flota-textSecondary">
                    ...
                    >
                        ...
                        <p className="text-lg w-full mx-auto tracking-wider text-center font-semibold font-serif text-flota-textSecondary">
                            Tu herramienta para gestionar de manera <span className="text-white font-semibol capitalize">eficiente</span> y <span className="text-white font-semibol capitalize">profesional</span> tus vehiculos.
                        </p>
                    </div>
                ...
                {/* ══ PANEL DERECHO ══ */}
                <div className="hidden md:flex w-3/5 h-full bg-flota-background items-center justify-center relative">
                    <div className="w-full max-w-3/4 px-6">

                        <div className="mb-10 anim-fade-up" style={{ animationDelay: '140ms' }}>
                            <h1 className="font-secundario tracking-wider text-[38px] leading-[1.1] text-flota-textPrimary">
                                Bienvenido
                            </h1>
                        </div>
                ...
                <div className="md:hidden ">
                    <Container>
                        {/* Título */}
                        <div
                            className="text-center mb-12 flex flex-col gap-y-3 w-full anim-fade-up"
                            style={{ animationDelay: '60ms' }}
                        >
                            <p className="text-5xl font-bold tracking-wider font-principal text-flota-textPrimary">
                                Flota<span className="text-flota-textSecondary">Control</span>
                            ...
                            <p className="text-lg w-full mx-auto tracking-wider text-center font-semibold font-serif text-flota-textSecondary">
                                Herramienta de gestion <span className="text-white font-semibol capitalize">eficiente</span> y <span className="text-white font-semibol capitalize">profesional</span> de vehiculos.
                            </p>
                        </div>

                        <form onSubmit={handleSubmit} className="flex flex-col gap-5 w-4/5 mx-auto">
